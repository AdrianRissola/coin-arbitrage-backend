...
const connect = async function(){
    ...
    const dbCon = await mongoose.connect(dbUri)
        .then( async ()=>{
            ...
            .then(result => {
                ...
                console.log(`loaded markets(${result.length}) from db: `, marketsDBmanager.getAllMarkets())
            })
            ...
            .then(result => {
                ...
                console.log(`loaded available Tickers(${result.length}) from db: `, marketsDBmanager.getAllAvailableTickers())
